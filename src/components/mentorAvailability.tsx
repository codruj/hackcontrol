...
import { Plus, Cancel, SaveFloppyDisk, Settings, Clock } from "@/ui/icons";
...
function GenerateSlotsForm({
  ...
  const { register, handleSubmit, watch } = useForm<GenerateFormValues>({
    ...
    <div>
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button icon={<Clock width={16} />} onClick={() => setIsGenerateOpen(true)}>
            Generate
          </Button>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed left-1/2 top-1/2 z-50 max-h-[90vh] w-[90vw] max-w-[480px] -translate-x-1/2 -translate-y-1/2 overflow-auto rounded-lg border border-neutral-800 bg-midnight p-6 shadow-2xl focus:outline-none">
            ...
            <GenerateSlotsForm
              ...
              onSuccess={() => { setIsGenerateOpen(false); refetch(); }}
